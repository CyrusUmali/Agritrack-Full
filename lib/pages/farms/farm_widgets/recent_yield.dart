...
class RecentYieldsWidget extends StatefulWidget {
  const RecentYieldsWidget({super.key});

  @override
  State<RecentYieldsWidget> createState() => _RecentYieldsWidgetState();
}

class _RecentYieldsWidgetState extends State<RecentYieldsWidget> {
